...
ZappiStore is creating a RPG game and we are trying to implement the rewarding logic for our game.
...
For example, at the end of a level, if a Warrior gathered 30 rage points, 20 mana points and 20 action points, he receives 46 coins.
